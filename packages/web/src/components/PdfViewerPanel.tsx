...
import type { AnnotationMode } from "./PdfAnnotationLayer";
                ...
                >
                  {annotationToolsVisible ? (
                    <>
                      ...
                      <div className="pdfAnnotationStatusText">第 {currentPageIndex + 1} 页</div>
                      <div className="pdfAnnotationStatusText">{currentPageAnnotations} 条标注</div>
